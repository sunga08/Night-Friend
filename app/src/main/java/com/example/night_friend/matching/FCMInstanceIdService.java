...
public class FCMInstanceIdService extends FirebaseMessagingService {
    ...
    private void sendNotification(Map<String, String> messageMap) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.drawable.button_matching)
    ...
    private void sendNotification(String messageTitle, String messageBody) {
        ...
        Intent intent = new Intent(this, Matching_chat.class);
    ...
    // 새 토큰이 생성될 때마다 호출 -> onTokenRefresh 대체
    @Override
    ...
    // FirebaseInstanceId.getInstance().getInstanceId() -> 현재 토큰 검색
}